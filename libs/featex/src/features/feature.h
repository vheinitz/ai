...
class creator##classname : public FeatureCreator { public: creator##classname(QString info):FeatureCreator(info){} Feature * create( ){ return new classname;} };\
...
public:
	...
	Feature* getFeature( QString name )
	{
...
public:
	...
	virtual TPFeatureResults extract( QImage & img, TFeatParams params, QList<QRect> * rois=0  )=0;
